...
REGISTERED_WORKFLOWS = {
    'cholesky': 'taps.wf.cholesky.workflow.CholeskyWorkflow',
    'docking': 'taps.wf.docking.workflow.DockingWorkflow',
    'fedlearn': 'taps.wf.fedlearn.workflow.FedLearnWorkflow',
    'mapreduce': 'taps.wf.mapreduce.workflow.MapreduceWorkflow',
    'moldesign': 'taps.wf.moldesign.workflow.MoldesignWorkflow',
    'montage': 'taps.wf.montage.workflow.MontageWorkflow',
    'synthetic': 'taps.wf.synthetic.workflow.SyntheticWorkflow',
}
...
def get_registered_workflow(name: str) -> type[Workflow[Any]]:
    ...
    Returns:
        The [`Workflow`][taps.workflow.Workflow] implementation type.
